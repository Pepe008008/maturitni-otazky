...
- ikonický procesor **x86** - většina dalších používala jeho architekturu (Intel atd.), založený na Von Neumannovi
- vs. procesory **ARM** - odlišná architektura, nejpoužívanější u mobilů a tabletů - nižší spotřeba, používá Harvardskou architekturu.
- grafická rozhraní
