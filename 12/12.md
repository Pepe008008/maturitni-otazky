...
- **DNS** = Domain Name System - převádí doménová jména na IP adresy a zpět
	...
	- FQDN - (fully qualified domain name) www. - subdomena, google - první úroveň, .com - top level domain 
	- 13 root serverů - decentralizace
- **NAT** = Network Adress Translation, technologie v routeru, která dovoluje vystupovat více zařízením pod jednou IP
- **TCP** vs **UDP**
